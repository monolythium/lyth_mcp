...
export function approvalUrl(): string | null {
 ...
 */
export async function requireApproval(req: ApprovalRequest): Promise<ApprovalDecision> {
  ...
  try {
    ...
    const decision = (await res.json()) as ApprovalDecision;
